  ...
  methods: {
    ...
    authConfigure(clientId) {
      ...
      msalApp = new msal.UserAgentApplication({
        auth: {
          clientId: clientId,
          authority: process.env.VUE_APP_AUTHORITY || 'https://login.microsoftonline.com/common/',
          validateAuthority: process.env.VUE_APP_VALIDATE_AUTHORITY === 'false' ? false : true
        },
        cache: {
